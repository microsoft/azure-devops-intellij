...
REM Example: For this github pull request https://github.com/Microsoft/azure-devops-intellij/pull/3, URL of mirror repository that was worked = https://github.com/yacaovsnc/azure-devops-intellij.git, branch name on the fork = master, pull request id = 3 
