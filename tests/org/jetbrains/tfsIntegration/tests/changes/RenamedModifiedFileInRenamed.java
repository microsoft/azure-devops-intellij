...
public class RenamedModifiedFileInRenamed extends ChangeTestCase {
  ...
  protected void makeChildChange(ParentChangesState parentChangesState) throws VcsException, IOException {
    ...
    final FilePath renamedFile =
      parentChangesState == ParentChangesState.NotDone ? myChildRenamedInParentOriginal : myChildRenamedInParentRenamed;
