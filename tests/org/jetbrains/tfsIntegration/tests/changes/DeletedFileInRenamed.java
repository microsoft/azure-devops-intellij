...
public class DeletedFileInRenamed extends ChangeTestCase {
  ...
  protected void makeChildChange(boolean parentChangeMade) throws VcsException {
    deleteFileInCommand(parentChangeMade ? myDeletedFileInRenamedFolder : myDeletedFileInOriginalFolder);
  }
  ...
  protected Change getPendingChildChange(boolean parentChangesMade) throws VcsException {
    return getChanges().getDeleteChange(parentChangesMade ? myDeletedFileInRenamedFolder : myDeletedFileInOriginalFolder);
  }
