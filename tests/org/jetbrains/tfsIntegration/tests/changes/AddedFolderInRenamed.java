...
public class AddedFolderInRenamed extends ChangeTestCase {
  ...
  protected void makeChildChange(ParentChangesState parentChangesState) throws VcsException {
    FilePath folder = parentChangesState == ParentChangesState.NotDone ? myAddedFolderInOriginalFolder : myAddedFolderInRenamedFolder;
  ...
  protected Change getPendingChildChange(ParentChangesState parentChangesState) throws VcsException {
    return getChanges()
      .getAddChange(parentChangesState == ParentChangesState.NotDone ? myAddedFolderInOriginalFolder : myAddedFolderInRenamedFolder);
  }
