...
public class AddedFolderInRenamed extends ChangeTestCase {
  ...
  protected void makeChildChange(boolean parentChangeMade) throws VcsException {
    FilePath folder = parentChangeMade ? myAddedFolderInRenamedFolder : myAddedFolderInOriginalFolder;
  ...
  protected Change getPendingChildChange(boolean parentChangesMade) throws VcsException {
    return getChanges().getAddChange(parentChangesMade ? myAddedFolderInRenamedFolder : myAddedFolderInOriginalFolder);
  }
