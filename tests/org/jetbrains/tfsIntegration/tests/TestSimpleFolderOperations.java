...
public class TestSimpleFolderOperations extends TFSTestCase {
    ...
    public void testPendingChangesRenameRoot() throws Exception {
        ...
        changes.assertRenamedOrMoved(pendingChanges.fileCheckedOutAndRenamedOriginal, TfsFileUtil.getFilePath(pendingChanges.fileCheckedOutAndRenamed));
    ...
    private class PendingChanges {
        ...
        public PendingChanges() throws Exception {
            ...
            rootfolder = createDirInCommand(mySandboxRoot, folderName);
            commit();
            ...
            fileCheckedOutAndRenamedOriginal = TfsFileUtil.getFilePath(fileCheckedOutAndRenamed);
            ...
            folderRenamedOriginal = TfsFileUtil.getFilePath(folderRenamed);
