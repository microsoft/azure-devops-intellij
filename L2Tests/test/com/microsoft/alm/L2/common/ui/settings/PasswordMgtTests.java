...
public class PasswordMgtTests extends L2Test {
    ...
    public void testDeletePassword() throws Exception {
        ...
        assertFalse(controller.isModified());
        assertEquals(1, model.getTableModel().getRowCount());
        assertEquals(1, ServerContextManager.getInstance().getAllServerContexts().size());
    }
    ...
    public void testUpdatePassword() {
        ...
        updatedContexts = new ArrayList<ServerContext>(ServerContextManager.getInstance().getAllServerContexts());
        assertTrue(updatedContexts.size() == originalContexts.size());
        assertFalse(updatedContexts.containsAll(originalContexts));
        assertEquals(originalContexts.get(0), updatedContexts.get(0));
        assertNotSame(originalContexts.get(0), updatedContexts.get(1));
        assertNotSame(originalContexts.get(1), updatedContexts.get(1));
        assertNotSame(originalContexts.get(1), updatedContexts.get(0));
    }
