...
public class IdeaHelper {
    ...
    /**
     * Use this method to find/create a server context object from the local context of the project.
     */
    public static ServerContext getServerContextFromProject(final Project project) {
        final ProjectLevelVcsManager projectLevelVcsManager = ProjectLevelVcsManager.getInstance(project);
        ...
        if (projectLevelVcsManager.hasActiveVcss()) {
            ...
            if (projectLevelVcsManager.checkVcsIsActive(GitVcs.NAME)) {
                ...
                if (repository != null && TfGitHelper.isTfGitRepository(repository)) {
                    ...
                    return ServerContextManager.getInstance().createContextFromGitRemoteUrl(gitRemoteUrl, false);
                }
                ...
                return ServerContextManager.getInstance().createContextFromTfvcServerUrl(workspace.getServer(), false);
            }
        }
