...
public class CreateWorkspaceCommandTest extends AbstractCommandTest {
    ...
    public void testConstructor_nullContext() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", null, null, null);
    }

    @Test
    public void testConstructor_withContext() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(context, "ws1", "comment2", null, null, null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_nullArgs() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, null, null, null, null, null);
    }
    ...
    public void testGetArgumentBuilder_private_checkin() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", Workspace.FileTime.CHECKIN, Workspace.Permission.PRIVATE, null);
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
    ...
    public void testGetArgumentBuilder_public_checkin() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", Workspace.FileTime.CHECKIN, Workspace.Permission.PUBLIC, null);
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
    ...
    public void testGetArgumentBuilder_limited_checkin() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", Workspace.FileTime.CHECKIN, Workspace.Permission.PUBLIC_LIMITED, null);
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
    ...
    public void testGetArgumentBuilder_private_current() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", Workspace.FileTime.CURRENT, Workspace.Permission.PRIVATE, null);
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
    ...
    public void testGetArgumentBuilder_current() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", Workspace.FileTime.CURRENT, null, null);
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
    ...
    public void testGetArgumentBuilder_private() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", null, Workspace.Permission.PRIVATE, null);
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
        Assert.assertEquals("workspace -noprompt -new -location:local ws1 -comment:comment2 -permission:Private", builder.toString());
    }

    @Test
    public void testGetArgumentBuilder_computername() {
        final CreateWorkspaceCommand cmd = new CreateWorkspaceCommand(null, "ws1", "comment2", null, Workspace.Permission.PRIVATE, "myComputerName");
        final ToolRunner.ArgumentBuilder builder = cmd.getArgumentBuilder();
        Assert.assertEquals("workspace -noprompt -new -location:local ws1 -comment:comment2 -permission:Private -computer:myComputerName", builder.toString());
    }
